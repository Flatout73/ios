...
#define k_returnCreateFolder                            0
#define k_returnCreateFotoAsset                         1
#define k_returnCreateFile                              2
#define k_returnCreateFileText                          3
#define k_returnCreateScanDocument                      4
